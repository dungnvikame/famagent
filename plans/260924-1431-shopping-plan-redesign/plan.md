...
| # | Phase | Status |
|---|-------|--------|
| 1 | [Món đồ + ghi nhận + trang mới](./phase-01-items-capture-page.md) | Pending |
| 2 | [Học mức dùng + đối soát sổ + kế hoạch tháng](./phase-02-learning-reconcile-plan.md) | Pending |
| 3 | [Thói quen + giai đoạn của bé + lịch sale/lương](./phase-03-habits-stages-calendar.md) | Pending |
| 4 | [Ảnh đơn hàng + PWA + nhắc sắp hết](./phase-04-photo-pwa-push.md) | Pending |
...
- [ ] Ghi được lần mua món không có trong catalog bằng 1 câu (Trợ lý hoặc ô ghi nhanh), có thẻ xác nhận, tự vào sổ Tiền.
- [ ] `/shopping` không còn lưới sản phẩm; catalog chỉ ở `/shopping/find`.
- [ ] Sau 2 lần mua cùng món, mức dùng “theo nhà mình” thay mặc định; test: ngày hết sai ≤ ±3 ngày trên dữ liệu mẫu đều đặn.
- [ ] Khoản chi Con/Mua sắm trong sổ chưa gắn món được hỏi “là mua gì?” và gắn 1 chạm (không tạo khoản trùng).
- [ ] Kế hoạch tháng đề xuất từ ngày hết + giai đoạn bé, tổng so ngân sách.
- [ ] Biểu đồ chi 6 tháng theo nhóm, nơi mua, giá/đơn vị, so mức trung bình theo tuổi.
- [ ] Ảnh đơn hàng → danh sách thẻ xác nhận (khi có AI + đồng ý).
- [ ] Cài được như app; bật nhắc → nhận push khi món còn ≤ 3 ngày (khi có VAPID).
- [ ] typecheck/lint/test xanh ở mỗi phase.
