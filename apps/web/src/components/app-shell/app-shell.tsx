...
import { Inbox, openInbox } from "@/components/inbox/inbox";
...
export function AppShell({ children }: { children: React.ReactNode }) {
  ...
  return <div className="app-shell">
    <aside className="app-side">
      ...
      <button type="button" className="inbox-trigger side" onClick={() => openInbox()} aria-haspopup="dialog">＋ Ghi nhanh</button>
    ...
    {/* Outside the sidebar: the sidebar is hidden on phones, the floating button is not. */}
    <Inbox />
  </div>;
}
