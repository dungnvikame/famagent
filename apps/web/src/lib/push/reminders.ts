...
/** Known items at ≤3 days left not yet reminded today, soonest first, at most `limit` per family per day. */
export function remindersFor(estimates: ItemEstimate[], sentToday: ReadonlySet<string>, limit = 2): Reminder[] {
