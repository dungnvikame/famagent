...
export function clearAllData(): void { for (const key of [PROFILE_KEY, CONVERSATIONS_KEY, SAVED_KEY, EVENTS_KEY, PENDING_IMPORT_KEY, "family-ai:money:v1"]) localStorage.removeItem(key); document.cookie = "family-ai-onboarded=; Path=/; SameSite=Lax; Max-Age=0"; }
