...
| 24/09/2026 | Tên hiển thị: FamAgent | Thay “Family AI” trên toàn giao diện; repo và tài liệu nội bộ giữ tên dự án. Giữ nguyên sau spec v2 (tài liệu viết “FamAgents”). |
| 24/09/2026 | Nhận [spec v2 Family OS](SPEC_V2_FAMILY_OS.md); điều hướng 5 mục **Trang chủ · Tiền · Mua sắm · Trợ lý · Gia đình** (`/home` `/money` `/shopping` `/agent` `/family`); Trang chủ = Family Brief, không mở vào chat | Sản phẩm là lớp vận hành gia đình, không phải shopping app có chat. `/shop` `/saved` `/products` chuyển hướng. Tài khoản & quyền riêng tư nằm trong Gia đình; tên + ảnh Google hiện ở sidebar. Kế hoạch: [plans/260924-1036-ux-redesign](../plans/260924-1036-ux-redesign/plan.md). Tiền: nhập tay dạng sổ Excel (không CSV ở alpha); Family Brief tuần chỉ trong app. |
